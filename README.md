...
| File | What it is |
|---|---|
| `PulseHWM-Setup-1.0.1.exe` | **Installer (recommended)** — one-click, Start-menu icon, optional desktop icon and "start at login" |
| `PulseHWM-v1.0.1-win64.zip` | Portable build — unzip anywhere and run `PulseHWM.exe` directly |
